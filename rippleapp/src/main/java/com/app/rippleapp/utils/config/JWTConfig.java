...
public class JWTConfig {
	...
	@Value("${rippleapp.security.jwt.keystore-location}")
	private String keyStorePath;
	
	@Value("${rippleapp.security.jwt.keystore-password}")
	private String keyStorePassword;
	
	@Value("${rippleapp.security.jwt.key-alias}")
	private String keyAlias;
	
	@Value("${rippleapp.security.jwt.private-key-passphrase}")
